...
\end{lstlisting}
            ...
            % TODO esta parte está muito solta%
...
\end{lstlisting}
            ...
            the ports used for each tux are: % TODO don't say this, just say we used these
...
\end{lstlisting}
            ...
            % TODO How many broadcast domains are there? How can you conclude it from the logs %
...
\end{lstlisting}
            ...
            % TODO broken english, but use the pings below on the lstlisting
...
\end{lstlisting}
            ...
            The configurations found in the config file % TODO ref to an appendix %
